...
function EPuser() {
  ...
  const handleSubmit=(()=>{
  let updateuser= {"condition_obj":{"email":email},"content_obj":{"name":name,"mobile":mobile,"city":city,"gender":gender,"address":address}}
  axios.patch(_apiurluser+"update",updateuser).then((Response)=>{
